...
import { StyleSheet, Text, TouchableOpacity, View, Clipboard, ToastAndroid, AlertIOS, Platform, Image, BackHandler } from 'react-native';
    ...
    return (
      <View style={styles.container}>
        ...
        <ShareSheet visible={this.state.visible} onCancel={this.onCancel.bind(this)}>
          ...
          <Button iconSrc={{ uri: COFFEE_ICON }}
                    onPress={()=>{
                this.onCancel();
              }}>Cancel</Button>
        </ShareSheet>
...
const COFFEE_ICON = "data:image/png;base64,"
